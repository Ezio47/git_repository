   ...
   public class WILD_BOTANYPROP
    {
       ...
       public static Message Save(WILD_BOTANYPROP_Model m)
        {
            StringBuilder sb = new StringBuilder();
            if (isExists(new WILD_BOTANYPROP_SW { BIOLOGICALTYPECODE = m.BIOLOGICALTYPECODE }))
            {
                sb.AppendFormat("Update WILD_BOTANYPROP Set ");
            ...
            {
                sb.AppendFormat("Insert Into WILD_BOTANYPROP(BIOLOGICALTYPECODE, PROTECTIONLEVELCODE, LIVINGSTATUSCODE)");
        ...
        /// <returns>参见模型</returns>
       public static DataTable getDT(WILD_BOTANYPROP_SW sw)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("SELECT * FROM WILD_BOTANYPROP WHERE 1=1");
       ...
       public static bool isExists(WILD_BOTANYPROP_SW sw)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("select 1 from WILD_BOTANYPROP where 1=1");
