   ...
   public class WILD_BOTANYFILE
    {
       ...
       public static Message Add(WILD_BOTANYFILE_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("INSERT INTO  WILD_BOTANYFILE(BIOLOGICALTYPECODE, PESTFILETITLE, PESTFILETYPE, PESTFILENAME, UPLOADTIME, UID) VALUES( ");
        ...
        /// <param name="m">参见模型</param>
        /// <returns>参见模型</returns>
       public static Message Mdy(WILD_BOTANYFILE_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("UPDATE WILD_BOTANYFILE SET ");
        ...
        /// <param name="m">参见模型</param>
        /// <returns>参见模型</returns>
       public static Message MdyTP(WILD_BOTANYFILE_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("UPDATE WILD_BOTANYFILE SET ");
            sb.AppendFormat(" PESTFILETITLE={0}", ClsSql.saveNullField(m.PESTFILETITLE));
        ...
        /// <param name="m">参见模型</param>
        /// <returns>参见模型</returns>
       public static Message Del(WILD_BOTANYFILE_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat(" DELETE FROM WILD_BOTANYFILE");
            sb.AppendFormat(" WHERE PESTFILEID= '{0}'", ClsSql.EncodeSql(m.PESTFILEID));
            bool bln = DataBaseClass.ExeSql(sb.ToString());
            if (bln == true)
