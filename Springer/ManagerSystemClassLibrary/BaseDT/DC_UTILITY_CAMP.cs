...
namespace ManagerSystemClassLibrary.BaseDT
{
    ...
    public class DC_UTILITY_CAMP
    {
        ...
        public static string getCountCAMPByOrgNo(DataTable dt, string orgNo, string DICTVALUE)
        {
            ...
            {
                if (string.IsNullOrEmpty(DICTVALUE))
                    return dt.Compute("count(DC_UTILITY_CAMP_ID)", "ORGNOS='" + PublicCls.getZhenIncOrgNo(orgNo) + "'").ToString();
                else
                    return dt.Compute("count(DC_UTILITY_CAMP_ID)", "ORGNOS='" + PublicCls.getZhenIncOrgNo(orgNo) + "' and STRUCTURETYPE='" + DICTVALUE + "'").ToString();
            }
            else //机构编码可能不正确
                return "";
        }
