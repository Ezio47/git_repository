   ...
   public class WILD_ANIMALFILE
    {
       ...
       public static Message Add(WILD_ANIMALFILE_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("INSERT INTO  WILD_ANIMALFILE(BIOLOGICALTYPECODE, PESTFILETITLE, PESTFILETYPE, PESTFILENAME, UPLOADTIME, UID) VALUES( ");
       ...
       /// <param name="m">参见模型</param>
       /// <returns>参见模型</returns>
       public static Message Mdy(WILD_ANIMALFILE_Model m)
       {
           StringBuilder sb = new StringBuilder();
           sb.AppendFormat("UPDATE WILD_ANIMALFILE SET ");
       ...
       /// <param name="m">参见模型</param>
       /// <returns>参见模型</returns>
       public static Message MdyTP(WILD_ANIMALFILE_Model m)
       {
           StringBuilder sb = new StringBuilder();
           sb.AppendFormat("UPDATE WILD_ANIMALFILE SET ");
           sb.AppendFormat(" PESTFILETITLE={0}", ClsSql.saveNullField(m.PESTFILETITLE));
       ...
       /// <param name="m">参见模型</param>
       /// <returns>参见模型</returns>
       public static Message Del(WILD_ANIMALFILE_Model m)
       {
           StringBuilder sb = new StringBuilder();
           sb.AppendFormat(" DELETE FROM WILD_ANIMALFILE");
           sb.AppendFormat(" WHERE PESTFILEID= '{0}'", ClsSql.EncodeSql(m.PESTFILEID));
           bool bln = DataBaseClass.ExeSql(sb.ToString());
           if (bln == true)
       ...
       /// <param name="sw"></param>
       /// <returns></returns>
       public static DataTable getDT(WILD_ANIMALFILE_SW sw)
       {
           StringBuilder sb = new StringBuilder();
           sb.AppendFormat(" FROM WILD_ANIMALFILE  WHERE 1=1");
