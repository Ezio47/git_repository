...
namespace ManagerSystemClassLibrary.BaseDT.SDE
{
    ...
    public class TD_CAR
    {
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Add(TD_CAR_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("insert into CHELIANG(OBJECTID,NAME,DISPLAY_X,DISPLAY_Y,Shape,category) values(");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Mdy(TD_CAR_Model m)
        {
            if (TD_CAR.isExists(new TD_CAR_Model { OBJECTID = m.OBJECTID }) == false)
            {
                StringBuilder sb = new StringBuilder();
                sb.AppendFormat("insert into CHELIANG(OBJECTID,NAME,DISPLAY_X,DISPLAY_Y,Shape,category) values(");
                sb.AppendFormat("{0},", ClsSql.saveNullField(m.OBJECTID));
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.AppendFormat("UPDATE CHELIANG");
                sb.AppendFormat(" set ");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Del(TD_CAR_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("delete CHELIANG");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static bool isExists(TD_CAR_Model m)
        {

            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("select 1 from CHELIANG where 1=1");
