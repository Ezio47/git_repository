...
namespace ManagerSystemClassLibrary.BaseDT.SDE
{
    ...
    /// 三维-宣传碑帖
    /// </summary>
    public class TD_PROPAGANDASTELE
    {
        /// <summary>
        /// 添加
        /// </summary>
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Add(TD_PROPAGANDASTELE_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("insert into XUANCHUANBEIPAI(OBJECTID,NAME,DISPLAY_X,DISPLAY_Y,Shape,category) values(");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Mdy(TD_PROPAGANDASTELE_Model m)
        {
            if (TD_PROPAGANDASTELE.isExists(new TD_PROPAGANDASTELE_Model { OBJECTID = m.OBJECTID }) == false)
            {
                StringBuilder sb = new StringBuilder();
                sb.AppendFormat("insert into XUANCHUANBEIPAI(OBJECTID,NAME,DISPLAY_X,DISPLAY_Y,Shape,category) values(");
                sb.AppendFormat("{0},", ClsSql.saveNullField(m.OBJECTID));
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.AppendFormat("UPDATE XUANCHUANBEIPAI");
                sb.AppendFormat(" set ");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Del(TD_PROPAGANDASTELE_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("delete XUANCHUANBEIPAI");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static bool isExists(TD_PROPAGANDASTELE_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("select 1 from XUANCHUANBEIPAI where 1=1");
