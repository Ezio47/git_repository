...
namespace ManagerSystemClassLibrary.BaseDT.SDE
{
    ...
    /// 三维-因子采集站
    /// </summary>
    public  class TD_FACTORCOLLECTSTATION
    {
        /// <summary>
        /// 三维添加
        /// </summary>
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Add(TD_FACTORCOLLECTSTATION_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("insert into YINZICAIJIZHAN(OBJECTID,NAME,DISPLAY_X,DISPLAY_Y,Shape,category) values(");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Mdy(TD_FACTORCOLLECTSTATION_Model m)
        {
            if (TD_FACTORCOLLECTSTATION.isExists(new TD_FACTORCOLLECTSTATION_Model { OBJECTID = m.OBJECTID }) == false)
            {
                StringBuilder sb = new StringBuilder();
                sb.AppendFormat("insert into YINZICAIJIZHAN(OBJECTID,NAME,DISPLAY_X,DISPLAY_Y,Shape,category) values(");
                sb.AppendFormat("{0},", ClsSql.saveNullField(m.OBJECTID));
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.AppendFormat("UPDATE YINZICAIJIZHAN");
                sb.AppendFormat(" set ");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Del(TD_FACTORCOLLECTSTATION_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("delete YINZICAIJIZHAN");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static bool isExists(TD_FACTORCOLLECTSTATION_Model m)
        {

            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("select 1 from YINZICAIJIZHAN where 1=1");
