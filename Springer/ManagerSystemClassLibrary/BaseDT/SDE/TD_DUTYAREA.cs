...
namespace ManagerSystemClassLibrary.BaseDT.SDE
{
    class TD_DUTYAREA
    {
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Add(TD_DUTYAREA_Model m)
        {
            Del(m);//先删除在添加，相当于修改
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("insert into ZERENQU(OBJECTID,ORGNAME,NAME,TELEPHONE,DISPLAY_X,DISPLAY_Y,Shape) values(");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Del(TD_DUTYAREA_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat(" ZERENQU");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Mdy(TD_DUTYAREA_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("UPDATE ZERENQU");
            sb.AppendFormat(" set ");
