...
namespace ManagerSystemClassLibrary.BaseDT.SDE
{
    ...
    public class TD_OVERWATCH
    {
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Add(TD_OVERWATCH_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("insert into LIAOWANGTAI(OBJECTID,NAME,DISPLAY_X,DISPLAY_Y,Shape,category) values(");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Mdy(TD_OVERWATCH_Model m)
        {
            if (TD_OVERWATCH.isExists(new TD_OVERWATCH_Model { OBJECTID = m.OBJECTID }) == false)
            {
                StringBuilder sb = new StringBuilder();
                sb.AppendFormat("insert into LIAOWANGTAI(OBJECTID,NAME,DISPLAY_X,DISPLAY_Y,Shape,category) values(");
                sb.AppendFormat("{0},", ClsSql.saveNullField(m.OBJECTID));
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.AppendFormat("UPDATE LIAOWANGTAI");
                sb.AppendFormat(" set ");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Del(TD_OVERWATCH_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("delete LIAOWANGTAI");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static bool isExists(TD_OVERWATCH_Model m)
        {

            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("select 1 from LIAOWANGTAI where 1=1");
