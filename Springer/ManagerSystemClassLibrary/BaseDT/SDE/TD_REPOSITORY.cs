...
namespace ManagerSystemClassLibrary.BaseDT.SDE
{
    ...
    public class TD_REPOSITORY
    {
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Add(TD_REPOSITORY_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("insert into CANGKU(OBJECTID,NAME,DISPLAY_X,DISPLAY_Y,Shape,category) values(");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Mdy(TD_REPOSITORY_Model m)
        {
            if (TD_REPOSITORY.isExists(new TD_REPOSITORY_Model { OBJECTID = m.OBJECTID }) == false)
            {
                StringBuilder sb = new StringBuilder();
                sb.AppendFormat("insert into CANGKU(OBJECTID,NAME,DISPLAY_X,DISPLAY_Y,Shape,category) values(");
                sb.AppendFormat("{0},", ClsSql.saveNullField(m.OBJECTID));
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Del(TD_REPOSITORY_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("delete CANGKU");
       ...
       /// <param name="m"></param>
       /// <returns></returns>
       public static bool isExists(TD_REPOSITORY_Model m)
       {

           StringBuilder sb = new StringBuilder();
           sb.AppendFormat("select 1 from CANGKU where 1=1");
