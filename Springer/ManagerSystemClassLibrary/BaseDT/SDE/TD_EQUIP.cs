...
namespace ManagerSystemClassLibrary.BaseDT.SDE
{
    ...
    public  class TD_EQUIP
    {
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Add(TD_EQUIP_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("insert into ZHUANGBEI(OBJECTID,NAME,DISPLAY_X,DISPLAY_Y,Shape,category) values(");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Mdy(TD_EQUIP_Model m)
        {
            if (TD_EQUIP.isExists(new TD_EQUIP_Model { OBJECTID = m.OBJECTID }) == false)
            {
                StringBuilder sb = new StringBuilder();
                sb.AppendFormat("insert into ZHUANGBEI(OBJECTID,NAME,DISPLAY_X,DISPLAY_Y,Shape,category) values(");
                sb.AppendFormat("{0},", ClsSql.saveNullField(m.OBJECTID));
            ...
            {
                StringBuilder sb = new StringBuilder();
                sb.AppendFormat("UPDATE ZHUANGBEI");
                sb.AppendFormat(" set ");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static Message Del(TD_EQUIP_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("delete ZHUANGBEI");
        ...
        /// <param name="m"></param>
        /// <returns></returns>
        public static bool isExists(TD_EQUIP_Model m)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat("select 1 from ZHUANGBEI where 1=1");
