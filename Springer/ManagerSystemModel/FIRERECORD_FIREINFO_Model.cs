...
{    
    ...
    /// 火情档案
    /// </summary>
    public class FIRERECORD_FIREINFO_Model
   {
       /// <summary>
       /// 序号
       /// </summary>
       ...
       /// </summary>
        ...
        /// 评估状态
        /// </summary>
        public string ASSESSSTATUE{ get; set; }
        /// <summary>
        /// 损失总计
        /// </summary>
        public float LOSSCOUNT { get; set; }
        /// <summary>
        /// 森林资源损失率
        /// </summary>
        public float FORESTRESOURCELOSSRATIO { get; set; }
        /// <summary>
        /// 人均损失平均价值量
        /// </summary>
        public float AVGLOSSPERCATITAVALUE { get; set; }
        /// <summary>
        /// 林地损失平均价值量
        /// </summary>
        public float WOODLANDLOSSAVGVALUE { get; set; }
        /// <summary>
        /// 扑火成效比
        /// </summary>
        public float FIRESUPPEFFECTTHAN { get; set; }
        /// <summary>
        /// 操作方法
        /// </summary>
