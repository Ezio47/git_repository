...
namespace DataBaseClassLibrary
{
    ...
    public class SDEDataBaseClass
    {
        ...
        private void OpenConn()
        {
            ...
            {
                connStr = ConfigurationManager.AppSettings["SpringerDBSDEConnection"].ToString();
        ...
        {
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.AppSettings["SpringerDBSDEConnection"].ToString()))
            {
                conn.Open();
