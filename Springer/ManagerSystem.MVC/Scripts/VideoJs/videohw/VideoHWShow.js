...
$(function () {
    ...
    WebVideoCtrl.I_InsertOBJECTPlugin("videoScreen");
...
function clickLogin(node) {
    ...
    var szIP = node.ip,
		szPort = node.port
    // alert("登录----==szIP==" + szIP + "===szPort===" + szPort);
    if ("" == szIP || "" == szPort) {
        return;
    }

   // alert("szIP=="+szIP+"szPort=="+szPort);
...
function getChannelInfo() {
    ...
    WebVideoCtrl.I_GetAnalogChannelInfo(szIP, {
        ...
        success: function (xmlDoc) {
            ...
            console.info(szIP + " 获取模拟通道成功！");
        },
        error: function () {
            console.info(szIP + " 获取模拟通道失败！");
        }
    });
    // 数字通道
    WebVideoCtrl.I_GetDigitalChannelInfo(szIP, {
        ...
        success: function (xmlDoc) {
            ...
            console.info(szIP + " 获取数字通道成功！");
        },
        error: function () {
            console.info(szIP + " 获取数字通道失败！");
        }
    });
    // 零通道
    WebVideoCtrl.I_GetZeroChannelInfo(szIP, {
        ...
        success: function (xmlDoc) {
            ...
            console.info(szIP + " 获取零通道成功！");
        },
        error: function () {
            console.info(szIP + " 获取零通道失败！");
        }
    });
    //console.info(snode);
    //开始预览
    console.info("szIP==" + szIP);
    clickStartRealPlay();
}
...
function clickStartRealPlay() {
    var IP = $("#ip").val();
    console.info("==szIP==" + IP);
    var oWndInfo = WebVideoCtrl.I_GetWindowStatus(g_iWndIndex),
		szIP = IP,// nodeip,//node.ip,
...
function clickEnableEZoom() {
    ...
    if (oWndInfo != null) {
        ...
        console.info(oWndInfo.szIP + " " + szInfo);
    }
}
    ...
    if (oWndInfo != null) {
        ...
        WebVideoCtrl.I_PTZControl(iPTZIndex, bStop, {
            ...
            success: function (xmlDoc) {
                ...
                console.info(oWndInfo.szIP + " 开启云台成功！");
            },
            error: function () {
                console.info(oWndInfo.szIP + " 开启云台失败！");
            }
        });
    }
}
...
function mouseUpPTZControl() {
    ...
    if (oWndInfo != null) {
        WebVideoCtrl.I_PTZControl(1, true, {
            success: function (xmlDoc) {
                console.info(oWndInfo.szIP + " 停止云台成功！");
            },
            error: function () {
                console.info(oWndInfo.szIP + " 停止云台失败！");
            }
        });
    }
}
...
function clickSetPreset() {
    ...
    if (oWndInfo != null) {
        WebVideoCtrl.I_SetPreset(iPresetID, {
            success: function (xmlDoc) {
                alert(oWndInfo.szIP + " 设置预置点成功！");
            },
            error: function () {
                alert(oWndInfo.szIP + " 设置预置点失败！");
            }
        });
    }
}
...
function PTZZoomIn() {
    ...
    if (oWndInfo != null) {
        WebVideoCtrl.I_PTZControl(10, false, {
            ...
            success: function (xmlDoc) {
                console.info(oWndInfo.szIP + " 调焦+成功！");
            },
            error: function () {
                console.info(oWndInfo.szIP + "  调焦+失败！");
            }
        });
    }
}
...
function PTZZoomStop() {
    ...
    if (oWndInfo != null) {
        WebVideoCtrl.I_PTZControl(11, true, {
            iWndIndex: g_iWndIndex,
            success: function (xmlDoc) {
                console.info(oWndInfo.szIP + " 调焦停止成功！");
            },
            error: function () {
                console.info(oWndInfo.szIP + "  调焦停止失败！");
            }
        });
    }
}
...
function PTZFocusIn() {
    ...
    if (oWndInfo != null) {
        WebVideoCtrl.I_PTZControl(12, false, {
            iWndIndex: g_iWndIndex,
            success: function (xmlDoc) {
                console.info(oWndInfo.szIP + " 聚焦+成功！");
            },
            error: function () {
                console.info(oWndInfo.szIP + "  聚焦+失败！");
            }
        });
    }
}
...
function PTZFoucusStop() {
    ...
    if (oWndInfo != null) {
        WebVideoCtrl.I_PTZControl(12, true, {
            iWndIndex: g_iWndIndex,
            success: function (xmlDoc) {
                console.info(oWndInfo.szIP + " 聚焦停止成功！");
            },
            error: function () {
                console.info(oWndInfo.szIP + "  聚焦停止失败！");
            }
        });
    }
}
...
function PTZIrisIn() {
    ...
    if (oWndInfo != null) {
        WebVideoCtrl.I_PTZControl(14, false, {
            iWndIndex: g_iWndIndex,
            success: function (xmlDoc) {
                console.info(oWndInfo.szIP + " 光圈+成功！");
            },
            error: function () {
                console.info(oWndInfo.szIP + "  光圈+失败！");
            }
        });
    }
}
...
function PTZIrisStop() {
    ...
    if (oWndInfo != null) {
        WebVideoCtrl.I_PTZControl(14, true, {
            iWndIndex: g_iWndIndex,
            success: function (xmlDoc) {
                console.info(oWndInfo.szIP + " 光圈停止成功！");
            },
            error: function () {
                console.info(oWndInfo.szIP + "  光圈停止失败！");
            }
        });
    }
}
